...
const Header = memo(function Header({ activeTab, setActiveTab }: HeaderProps) {
  return (
      ...
      <div className="flex justify-between items-center w-full px-5 md:px-8 py-3">
        ...
        <nav className="hidden md:flex gap-8">
          {navItems.map((item) => (
            <button
              ...
              className={`font-headline-md uppercase tracking-widest text-xs transition-all active:scale-95 duration-300 ${
                activeTab === item.id
        ...
        <div className="flex items-center gap-4 text-primary-container">
          <a
            ...
            aria-label="GitHub"
          >
            <Icon name="code" className="cursor-pointer hover:scale-110 transition-transform" />
          </a>
          ...
          <a
            ...
            aria-label="LinkedIn"
          >
            <Icon name="badge" className="cursor-pointer hover:scale-110 transition-transform" />
          </a>

          <a href={`mailto:${profile.email}`} aria-label="Email">
            <Icon name="mail" className="cursor-pointer hover:scale-110 transition-transform" />
          </a>
